        ...
        <>
            <section>
                <div className="container blackbg">
                    <div className="row">
                        <div className='col-12 col-md-6 d-flex justify-content-center align-items-center flex-column text-center text-md-start'>
                            <div>
                                <h1 className='fw-bold size'>When One Thrives,<br /> We All Rise</h1>
                                <p className='fs-2'>Logistics Network Reimagined</p>
                                <button type="button" className="btn btnbg fe-semibold">Become a Member</button>
                            </div>
                        </div>
            ...
            <section>
                <div className="container blacklight py-5 px-2">
                    ...
                    <div className="row mx-auto align-items-stretch blacklight">
                        <div className="col-12 col-sm-4 col-lg-6 blacklight mb-3 ">
                            <div className="border m-2 h-100 blackdark d-flex flex-column  p-2">
